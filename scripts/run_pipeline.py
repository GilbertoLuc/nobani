...
# è usato come se fosse 'cd ..' nel terminale, facendoci lavorare su una directory indietro

import logging
from src import config
from src.load_data import load_data
from src.preprocess import preprocess_data
from src.make_model import train_model_rf, train_model_logistic
...
if __name__ == "__main__": # questo funziona in modo che if sia accettato solo se stiamo facendo girare 
    main()  # main() nel codice in cui è stato creato, sena importarlo
